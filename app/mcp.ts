...
import type { ChatCompletionTool } from "openai/resources/chat/completions";import { Client } from "@modelcontextprotocol/sdk/client/index.js";
import { StdioClientTransport } from "@modelcontextprotocol/sdk/client/stdio.js";
import type { CallToolResult, Tool } from "@modelcontextprotocol/sdk/types.js";
import { truncateToolResult } from "./toolResult.ts";
import { resolveMcpConfigPath } from "./pathSecurity.ts";
...
async function loadMcpConfig(
  ...
  const resolved = resolveMcpConfigPath(process.cwd(), configPath);
  try {
